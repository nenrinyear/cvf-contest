...
const serviceAccount = {
    ...
    private_key: process.env.CVF2023_Firebase_PrivateKey,
    client_email: "firebase-adminsdk-bbrtz@creating-videos-festival.iam.gserviceaccount.com",
...
export const firebaseAdmin = getApps().length ? getApps()[0] :  initializeApp({ credential: cert(JSON.stringify(serviceAccount)) });
